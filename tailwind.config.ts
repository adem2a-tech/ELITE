    ...
    extend: {
      ...
      keyframes: {
        ...
        'entrance-3d': {
          '0%': {
            opacity: '0',
            transform: 'perspective(800px) rotateX(-12deg) translateY(30px) scale(0.9)',
          },
          '100%': {
            opacity: '1',
        ...
        'scale-in': {
          '0%': {
            opacity: '0',
            transform: 'perspective(1000px) scale(0.85) translateZ(-80px)',
          },
          '100%': {
            opacity: '1',
        ...
        'slide-in-bottom': {
          '0%': {
            opacity: '0',
            transform: 'perspective(600px) translateY(40px) rotateX(8deg)',
          },
          '100%': {
            opacity: '1',
      ...
      animation: {
        ...
        'entrance-3d': 'entrance-3d 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards',
